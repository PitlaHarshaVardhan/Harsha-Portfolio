...
export default function Overlay() {
  ...
  return (
    <div ref={ref} className="absolute inset-0 z-10 pointer-events-none">
      ...
      >
        <h1 className="text-6xl md:text-9xl font-bold tracking-tighter mb-4 text-white mix-blend-difference leading-none drop-shadow-[0_8px_8px_rgba(0,0,0,0.8)] drop-shadow-[0_0_30px_rgba(0,0,0,0.6)]">
          Harsha Vardhan
        </h1>
        <p className="text-xl md:text-4xl text-white/80 font-light mix-blend-difference tracking-wide drop-shadow-[0_4px_4px_rgba(0,0,0,0.8)] drop-shadow-[0_0_20px_rgba(0,0,0,0.6)]">
      ...
      <motion.div
        ...
        style={{ opacity: o3 }}
      >
        <motion.div style={{ y: y3 }} className="max-w-4xl">
