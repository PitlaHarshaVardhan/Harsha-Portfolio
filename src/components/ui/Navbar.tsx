  ...
  return (
    <>
      <motion.nav
        ...
        className="fixed top-0 left-0 w-full z-50 px-6 py-6 flex justify-between items-center text-white pointer-events-none"
      >
        ...
        <div className="hidden md:flex gap-4 pointer-events-auto">
          <a
            href="https://github.com/PitlaHarshaVardhan"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/pitlaharshavardhan"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-white/60 transition-colors"
          >
